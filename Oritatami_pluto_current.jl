...
md"""
Plotting backend: $(@bind backend Select(["gr" => "GR", "plotly" => "plotly", "inspectdr" => "InspectDR"]))
``~~~~~~~~~~~~~~~~~~~~~~~~~``
...
begin
	...
	rightfile = "sampleOS\\turnright1_1.auri.txt"
	rightturnfile1 = "sampleOS\\turnrightup_v4.auri.txt"
	rightturnfile2 = "sampleOS\\turnrightdown_v4.auri.txt"
	rightturnfile3 = "sampleOS\\turnrightgliderup_v4.auri.txt"
	
	rightturnfile4 = "sampleOS\\turnrightgliderdown_v4.auri.txt"

	smallgliderfile = "sampleOS\\smallglider6.auri.txt"
	
	gapright = "sampleOS\\gapright.auri.txt"
	gapharmonica = "sampleOS\\gapharmonica.auri.txt"
	gapleft = "sampleOS\\gapleft.auri.txt"
	gapleftshift = "sampleOS\\gapleftshift.auri.txt"
	halfadder3x4 = "sampleOS\\3x4_halfadder.auri.txt"
...
begin
	...
	if osdef == "fromfile"
		...
		#os = loadOS(rightfile)
		#os = loadOS(rightturnfile1)
		#os = loadOS(rightturnfile2)
		#os = loadOS(rightturnfile3)
		#os = loadOS(rightturnfile4)
		#os = loadOS(smallgliderfile)
		#os = loadOS(gapright)
		#os = loadOS(gapharmonica)
		#os = loadOS(gapleft)
		#os = loadOS(gapleftshift)
		os = loadOS(halfadder3x4)
	else
